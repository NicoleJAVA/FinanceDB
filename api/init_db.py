...
def init_db():
    ...
    if count == 0:
        ...
        ('A01', '2330', 'Buy', '2024-08-01', 100, 100.00, 1.00, 0.00, 99.00, 100, NULL),
        ('A02', '2330', 'Buy', '2024-07-31', 200, 400.00, 2.00, 0.00, 398.00, 200, NULL),
        ('A03', '2330', 'Buy', '2024-07-30', 300, 900.00, 3.00, 0.00, 897.00, 300, NULL),
        ('A04', '2330', 'Buy', '2024-07-29', 400, 1600.00, 4.00, 0.00, 1596.00, 400, NULL),
        ('A05', '2330', 'Buy', '2024-07-28', 500, 2500.00, 5.00, 0.00, 2495.00, 500, NULL),
        ('A06', '2330', 'Buy', '2024-07-27', 600, 3600.00, 6.00, 0.00, 3594.00, 600, NULL),
        ('A07', '2330', 'Buy', '2024-07-26', 700, 4900.00, 7.00, 0.00, 4893.00, 700, NULL),
        ('A08', '2330', 'Buy', '2024-07-25', 800, 6400.00, 8.00, 0.00, 6392.00, 800, NULL),
        ('A09', '2330', 'Buy', '2024-07-24', 900, 8100.00, 9.00, 0.00, 8091.00, 900, NULL),
        ('A10', '2330', 'Buy', '2024-07-23', 1000, 10000.00, 10.00, 0.00, 9990.00, 1000, NULL);
        """)
